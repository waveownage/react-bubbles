...
A Token allows users to access protected pages by using login.

- [ ] What steps can you take in your web apps to keep your data secure?

By adding cookies and/or tokens.

- [ ] Describe how web servers work.

They allow you to grab, delete, or update data in a seperate location.
